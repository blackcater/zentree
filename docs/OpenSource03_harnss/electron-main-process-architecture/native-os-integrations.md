...
- [electron/src/lib/**tests**/notification-utils.test.ts](electron/src/lib/__tests__/notification-utils.test.ts)
- [electron/src/lib/**tests**/terminal-history.test.ts](electron/src/lib/__tests__/terminal-history.test.ts)
- [electron/src/lib/**tests**/terminal-tabs.test.ts](electron/src/lib/__tests__/terminal-tabs.test.ts)
