...
_For details, see [Claude Engine: Sessions & Streaming](#3.1)._
...
_For details, see [ACP Engine: Agent Client Protocol](#3.2)._
...
_For details, see [Codex Engine: JSON-RPC Protocol](#3.3)._
...
_For details, see [Agent Registry & Binary Management](#3.4)._
...
_For details, see [Background Agents & Task Lifecycle](#3.5)._
