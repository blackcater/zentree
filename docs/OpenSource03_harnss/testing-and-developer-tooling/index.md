...
- **Chat Scrolling**: Mathematical helpers for "bottom-lock" behavior, ensuring the UI correctly sticks to the bottom during message streaming unless the user manually scrolls up [electron/src/lib/**tests**/chat-scroll.test.ts:1-62]().
